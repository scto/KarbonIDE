...
public class ThemeTrieElementRule {
  ...
  @Nullable public final List<String> parentScopes;
  ...
  public ThemeTrieElementRule clone() {
    return new ThemeTrieElementRule(
        this.scopeDepth, this.parentScopes, this.fontStyle, this.foreground, this.background);
  }
  ...
  public void acceptOverwrite(
      final int scopeDepth, final int fontStyle, final int foreground, final int background) {
