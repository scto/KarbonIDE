...
public final class RawGrammarReader {
  ...
  public static final ObjectFactory<RawGrammar> OBJECT_FACTORY =
      new ObjectFactory<>() {
        @Override
