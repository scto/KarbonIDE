...
public class ContentChangeEvent extends Event {
  ...
  public ContentChangeEvent(
      ...
      int action,
      @NonNull CharPosition changeStart,
      @NonNull CharPosition changeEnd,
      @NonNull CharSequence textChanged,
      boolean causeByUndoManager) {
    super(editor);
    this.action = action;
    start = changeStart;
    end = changeEnd;
   ...
   * Content instance is returned. If action is {@link #ACTION_INSERT}, inserted text is returned.
