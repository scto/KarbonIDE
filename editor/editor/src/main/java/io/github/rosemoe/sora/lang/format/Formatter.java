...
public interface Formatter {
   ...
   *
   * <p>Format the content directly, and call {@link FormatResultReceiver} to receive the formatted
   * content from the editor when the formatting is complete *
   *
   ...
   */
  void formatRegion(
      @NonNull Content text, @NonNull TextRange rangeToFormat, @NonNull TextRange cursorRange);
