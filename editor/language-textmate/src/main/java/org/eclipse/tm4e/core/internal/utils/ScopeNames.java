 ...
 *
 * <p>Contributors: - Sebastian Thomschke - initial API and implementation
 */
...
/**
 * Utility class to deal with plugin scoped TextMate Scope Names, e.g.
 * "source.batchfile@com.example.myplugin"
 */
public final class ScopeNames {
  ...
  /**
   * @return true if a scope name is suffixed by the contributing plugin id, e.g.
   *     "source.batchfile@com.example.myplugin"
   */
