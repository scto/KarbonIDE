...
public class CodeBlock {
  ...
  /**
   * Performs a binary search to find the index of the smallest code block whose end line is greater
   * than or equal to the specified line.
   *
   * <p>This implementation also handles the case where the elements in the list are <code>null
   * </code>. If a null element is encountered at <code>mid</code>, we look for the first non-null
   * element either before and after the element and set it as <code>mid</code>.
   *
