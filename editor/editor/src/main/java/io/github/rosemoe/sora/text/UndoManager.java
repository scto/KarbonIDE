...
public final class UndoManager implements ContentListener, Parcelable {
  ...
  public void setMaxUndoStackSize(int maxSize) {
    if (maxSize <= 0) {
      throw new IllegalArgumentException(
          "max size can not be zero or smaller.Did you want to disable undo module by calling"
              + " setUndoEnabled()?");
    }
   ...
   * @author Rosemoe
   */
  public abstract static class ContentAction implements Parcelable {
  ...
  public static final class ReplaceAction extends ContentAction {
    ...
    @Override
    public String toString() {
      return "ReplaceAction{" + "insert=" + insert + ", delete=" + delete + '}';
    }
