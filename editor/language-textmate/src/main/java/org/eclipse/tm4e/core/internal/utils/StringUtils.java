 ...
 * license - Angelo Zerr <angelo.zerr@gmail.com> - translation and adaptation to Java - Sebastian
 * Thomschke - add splitToArray/List methods
 */
...
public final class StringUtils {
   ...
   *
   * <p>7.5 times faster than {@link String#split(String)} and 2.5 times faster than {@link
  ...
  public static String substringBefore(
      final String searchIn, final char searchFor, final String defaultValue) {
  ...
  public static String toString(
      @Nullable final Object object, final Consumer<StringBuilder> fieldsBuilder) {
