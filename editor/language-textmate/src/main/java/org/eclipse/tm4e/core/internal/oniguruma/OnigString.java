 ...
 *
 * <p>Initial code from https://github.com/atom/node-oniguruma Initial copyright Copyright (c) 2013
 * GitHub Inc. Initial license: MIT
 *
 * <p>Contributors: - GitHub Inc.: Initial code, written in JavaScript, licensed under MIT license -
 * Angelo Zerr <angelo.zerr@gmail.com> - translation and adaptation to Java - Fabio Zadrozny
 * <fabiofz@gmail.com> - Convert uniqueId to Object (for identity compare) - Fabio Zadrozny
 * <fabiofz@gmail.com> - Utilities to convert between utf-8 and utf-16
 */
...
public abstract class OnigString {
  ...
  static final class MultiByteString extends OnigString {
    ...
    /**
     * For each byte holds the index of the char to which the byte belongs. E.g. in case of <code>
     * byteToCharOffsets[100] == 60 && byteToCharOffsets[101] == 60</code>, the bytes at indexes 100
     * and 101 both belong to the same multi-byte character at index 60.
     */
    ...
    private int[] getByteToCharOffsets() {
      ...
      if (offsets == null) {
        ...
        while (byteIndex <= maxByteIndex) {
          ...
          // same as "Arrays.fill(offsets, byteIndex, byteIndex + charLenInBytes, charIndex)" but
          // faster
  ...
  protected final void throwOutOfBoundsException(
      final String indexName, final int index, final int minIndex, final int maxIndex) {
