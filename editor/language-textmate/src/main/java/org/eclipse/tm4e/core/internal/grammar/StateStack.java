...
public final class StateStack implements IStateStack {
  ...
  public static final StateStack NULL =
      new StateStack(null, RuleId.NO_RULE, 0, 0, false, null, null, null);
  ...
  /**
   * The captured anchor position when this stack element was pushed. This is relevant only while
   * tokenizing a line, to restore the anchor position when popping. Its value is meaningless across
   * lines.
   */
  ...
  @Nullable private final StateStack parent;

  /** The state (rule) that this element represents. */
  private final RuleId ruleId;

  /**
   * The state has entered and captured \n. This means that the next line should have an
   * anchorPosition of 0.
   */
  ...
  StateStack withContentNameScopesList(final @Nullable AttributedScopeStack contentNameScopesList) {
    ...
    return castNonNull(this.parent)
        .push(
            this.ruleId,
            this._enterPos,
            this._anchorPos,
  ...
  public static StateStack pushFrame(@Nullable final StateStack self, final Frame frame) {
    final var namesScopeList =
        AttributedScopeStack.fromExtension(
            self == null ? null : self.nameScopesList, frame.nameScopesList);
