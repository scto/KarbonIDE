...
public class RegionIterator {
  ...
  /**
   * Get the source index of dividing points in provider with given index {@code i}. Source index is
   * the index of dividing point that leads to current region.
   *
   * @param i Index of provider
   */
  ...
  /** Get start index of the region Note that this is inclusive. */
  public int getStartIndex() {
    return startIndex;
  }

  /** Get end index of the region. Note that this is exclusive. */
