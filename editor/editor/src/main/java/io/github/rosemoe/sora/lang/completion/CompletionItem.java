...
public abstract class CompletionItem {
  ...
  @Nullable protected CompletionItemKind kind;

  /** Use for default sort */
  public int prefixLength = 0;

  /**
   * A string that should be used when comparing this item with other items. When null the {@link
   * #label label} is used.
   */
  @Nullable public String sortText;

  @Nullable protected Object extra;
