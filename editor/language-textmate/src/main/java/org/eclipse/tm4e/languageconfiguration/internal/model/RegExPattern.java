...
public abstract class RegExPattern {
  ...
  private static final class JavaRegExPattern extends RegExPattern {
    ...
    JavaRegExPattern(final String pattern, final @Nullable String flags)
  ...
  private static final class OnigRegExPattern extends RegExPattern {
    ...
    OnigRegExPattern(final String pattern, final @Nullable String flags)
        throws PatternSyntaxException {
   ...
   * @return null if pattern is null or the pattern is invalid
   */
  public static @Nullable RegExPattern ofNullable(
      final @Nullable String pattern, final @Nullable String flags) {
    if (pattern != null) {
      try {
        return new JavaRegExPattern(pattern, flags);
      } catch (Exception ex) {
