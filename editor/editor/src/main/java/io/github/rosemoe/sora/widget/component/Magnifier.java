...
public class Magnifier implements EditorBuiltinComponent {
  ...
  /**
   * If true, the magnifier will never try to copy pixels by system and create the image by editor.
      ...
      PixelCopy.request(
          ...
          (var statusCode) -> {
            ...
            if (statusCode == PixelCopy.SUCCESS) {
              ...
              var scaled =
                  Bitmap.createScaledBitmap(clip, popup.getWidth(), popup.getHeight(), true);
              clip.recycle();
