...
/**
 * This class generate plain spans for content, in case when using a language without analysis you
 * can still provide context-free completions. By default, editor does not show completions when no
 * span is set on the text. This would be helpful for enabling completion for pure texts.
 *
 * @author Rosemoe
 */
public final class PlainTextAnalyzeManager extends BaseAnalyzeManager {
  ...
  @Override
  public void insert(
      @NonNull CharPosition start,
      @NonNull CharPosition end,
