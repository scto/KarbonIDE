 ...
 * <fabiofz@gmail.com> - Fix recursion error on creation of OnigRegExp with unicode chars
 */
...
public final class OnigRegExp {
  ...
  @Nullable private OnigString lastSearchString;

  private int lastSearchPosition = -1;

  @Nullable private OnigResult lastSearchResult;
  ...
  public OnigRegExp(final String pattern, final boolean ignoreCase) {
    ...
    try {
      ...
      if (ignoreCase) options |= Option.IGNORECASE;
      regex =
          new Regex(
              patternBytes,
              0,
