...
public interface AnalyzeManager {
   ...
   *
   * <p>This is called when the {@link io.github.rosemoe.sora.lang.Language} is going to be used by
   * an editor. It will also be called when the instance is no longer used. Make sure you check the
   * exact receiver at the time you send results to it. Thus, you should save the instance at your
   * side.
   */
  ...
  /**
   * The {@link ContentReference} set by {@link #reset(ContentReference, Bundle)} has inserted text
   ...
   */
  void delete(
      @NonNull CharPosition start, @NonNull CharPosition end, @NonNull CharSequence deletedContent);

  /** Rerun the analysis forcibly */
  void rerun();

  /**
   * Destroy the manager. Release any resources held. Make sure that you will not call the receiver
   * anymore.
   */
  void destroy();
}
