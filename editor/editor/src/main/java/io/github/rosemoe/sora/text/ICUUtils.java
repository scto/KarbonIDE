...
/**
 * Utility class for invoking ICU library according to Android platform. Provide default
...
public class ICUUtils {
  ...
  /**
   * Primitive implementation of {@link #getWordRange(CharSequence, int, boolean)} when ICU is not
   * enabled
   */
