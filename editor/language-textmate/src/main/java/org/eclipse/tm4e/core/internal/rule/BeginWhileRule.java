...
public final class BeginWhileRule extends Rule {
  ...
  @Nullable private RegExpSourceList cachedCompiledPatterns;

  @Nullable private RegExpSourceList cachedCompiledWhilePatterns;
  ...
  BeginWhileRule(
      ...
      final String begin,
      final List<@Nullable CaptureRule> beginCaptures,
      final String _while,
      final List<@Nullable CaptureRule> whileCaptures,
  ...
  public String getWhileWithResolvedBackReferences(
      final CharSequence lineText, final OnigCaptureIndex[] captureIndices) {
  ...
  @Override
  public CompiledRule compileAG(
      final IRuleRegistry grammar,
  ...
  public CompiledRule compileWhileAG(
      @Nullable final String endRegexSource, final boolean allowA, final boolean allowG) {
  ...
  private RegExpSourceList getCachedCompiledWhilePatterns(@Nullable final String endRegexSource) {
    ...
    if (cachedCompiledWhilePatterns == null) {
      ...
      cachedCompiledWhilePatterns.add(
          this.whileHasBackReferences ? this._while.clone() : this._while);
