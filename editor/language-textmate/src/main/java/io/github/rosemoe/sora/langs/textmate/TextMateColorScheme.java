...
public class TextMateColorScheme extends EditorColorScheme
  ...
  private void applyVSCTheme(RawTheme RawTheme) {
    ...
    String lineHighlightActiveForeground =
        (String) RawTheme.get("editorLineNumber.activeForeground");
    ...
    String completionWindowBackgroundCurrent =
        (String) RawTheme.get("completionWindowBackgroundCurrent");
    ...
    String editorIndentGuideActiveBackground =
        (String) RawTheme.get("editorIndentGuide.activeBackground");
