...
public class IndentRulesSupport {
  ...
  public boolean shouldIndentNextLine(final String text) {
    return this._indentationRules.indentNextLinePattern != null
        && this._indentationRules.indentNextLinePattern.matchesFully(text);
  }

  public boolean shouldIgnore(final String text) {
    // the text matches `unIndentedLinePattern`
    return this._indentationRules.unIndentedLinePattern != null
        && this._indentationRules.unIndentedLinePattern.matchesFully(text);
  }
