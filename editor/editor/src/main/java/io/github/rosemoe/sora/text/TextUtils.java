...
public class TextUtils {
   ...
   * @return A long packed with the number of spaces and tabs at the start of the line. Use {@link
   *     IntPair#getFirst(long)} to get the number of spaces and {@link IntPair#getSecond(long)} for
   *     the number of tabs.
   */
