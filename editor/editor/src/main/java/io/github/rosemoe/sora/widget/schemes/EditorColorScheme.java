 ...
 * pool for custom languages. We recommend adding a base offset for your custom color IDs. For
 * example, first custom color ID is 256. This leaves enough space for editor's future built-in
 * colors.
 *
 ...
 * different default colors. Subclasses are expected to override {@link #applyDefault()} to define
...
public class EditorColorScheme {
  ...
  private static final int PRIMARY_TEXT_COLOR_DEFAULT_LIGHT = 0xff424242;
  private static final int PRIMARY_TEXT_COLOR_DEFAULT_DARK = 0xfff5f5f5;
  private static final int BACKGROUND_COLOR_LIGHT = 0xfffefefe;
  private static final int BACKGROUND_COLOR_DARK = 0xff212121;
  private static final int SECONDARY_TEXT_COLOR_LIGHT = 0xff616161;
  private static final int SECONDARY_TEXT_COLOR_DARK = 0xffeeeeee;
