...
public class TextMateLanguage extends EmptyLanguage {
  ...
  @Deprecated
  public static IGrammar prepareLoad(
      IGrammarSource grammarSource,
      @Nullable Reader languageConfiguration,
  ...
  public static TextMateLanguage create(
      IGrammarSource grammarSource, Reader languageConfiguration, IThemeSource themeSource) {
  ...
  @Deprecated
  public static TextMateLanguage createNoCompletion(
      IGrammarSource grammarSource, IThemeSource themeSource) {
    var grammar = prepareLoad(grammarSource, null, themeSource);
    return create(grammar.getScopeName(), false);
  }
  ...
  public static TextMateLanguage create(
      String languageScopeName, GrammarRegistry grammarRegistry, boolean autoCompleteEnabled) {
    return create(
        languageScopeName, grammarRegistry, ThemeRegistry.getInstance(), autoCompleteEnabled);
  }
  ...
  public static TextMateLanguage create(
    ...
    return new TextMateLanguage(
        grammar, languageConfiguration, grammarRegistry, themeRegistry, autoCompleteEnabled);
  }

  public static TextMateLanguage create(
      GrammarDefinition grammarDefinition, boolean autoCompleteEnabled) {
  ...
  public static TextMateLanguage create(
      ...
      boolean autoCompleteEnabled) {
    return create(
        grammarDefinition, grammarRegistry, ThemeRegistry.getInstance(), autoCompleteEnabled);
  }
  ...
  /**
   * When you update the {@link TextMateColorScheme} for editor, you need to synchronize the updates
   * here
   *
    ...
    try {
      textMateAnalyzer =
          new TextMateAnalyzer(
              this, grammar, languageConfiguration, /*grammarRegistry,*/ themeRegistry);
    } catch (Exception e) {
      e.printStackTrace();
    }
