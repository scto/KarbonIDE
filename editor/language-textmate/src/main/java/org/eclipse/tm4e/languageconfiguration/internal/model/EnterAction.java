...
public class EnterAction {
  ...
  public enum IndentAction {
    ...
    Indent,
    /**
     * Insert two new lines: - the first one indented which will hold the cursor - the second one at
  ...
  public EnterAction(
      ...
      final @Nullable String appendText,
      final @Nullable Integer removeText) {
