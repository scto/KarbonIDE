 ...
 *
 * <p>Contributors: Angelo Zerr <angelo.zerr@gmail.com> - initial API and implementation Sebastian
...
public final class OnEnterRule {
  ...
  public OnEnterRule(
      final RegExPattern beforeText,
      final @Nullable RegExPattern afterText,
      final @Nullable RegExPattern previousLineText,
  ...
  OnEnterRule(
      ...
      final @Nullable String previousLineText,
      final EnterAction action) {
