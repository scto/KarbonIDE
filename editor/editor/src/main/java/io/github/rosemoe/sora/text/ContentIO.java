...
public class ContentIO {
  ...
  /**
   * Create a {@link Content} from stream. The stream will get closed if the operation is
   * successfully done.
   *
   ...
   */
  @NonNull
  public static Content createFrom(@NonNull InputStream stream, @NonNull Charset charset)
      throws IOException {
   ...
   *
   * <p>The reader will get closed if the operation is successfully done.
   */
  @NonNull
  ...
  /**
   * Write the text to the given stream with default charset. Close the stream if {@code
   * closeOnSucceed} is true.
   *
  ...
  public static void writeTo(
      @NonNull Content text, @NonNull OutputStream stream, boolean closeOnSucceed)
      throws IOException {
    writeTo(text, stream, Charset.defaultCharset(), closeOnSucceed);
  }

  /**
   * Write the text to the given stream with given charset. Close the stream if {@code
   * closeOnSucceed} is true.
   *
   * @param text Text to be written
   * @param stream Output stream
   ...
   *
   * <p>If you use {@link BufferedWriter}, make sure you set an appropriate buffer size. We
   * recommend using the default size (8192) or larger.
   *
   * @param text Text to be written
   * @param writer Output writer
   * @param closeOnSucceed If true, the stream will be closed when operation is successfully
   */
  public static void writeTo(@NonNull Content text, @NonNull Writer writer, boolean closeOnSucceed)
      throws IOException {
