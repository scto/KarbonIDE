/**
 * Copyright (c) 2022 Sebastian Thomschke. This program and the accompanying materials are made
...
public class StyleAttributes {
  ...
  public static StyleAttributes of(
      final int fontStyle, final int foregroundId, final int backgroundId) {
