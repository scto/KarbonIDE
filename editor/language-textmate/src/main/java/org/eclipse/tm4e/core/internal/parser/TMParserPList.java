/**
 * Copyright (c) 2015-2018 Angelo ZERR. Copyright (c) 2023 Vegard IT GmbH and others. This program
 * and the accompanying materials are made available under the terms of the Eclipse Public License
 * 2.0 which is available at https://www.eclipse.org/legal/epl-2.0/
 *
 * <p>SPDX-License-Identifier: EPL-2.0
 *
 * <p>Contributors: - Angelo Zerr <angelo.zerr@gmail.com> - initial API and implementation, see
...
public final class TMParserPList implements TMParser {
  ...
  @Override
  public <T extends PropertySettable<?>> T parse(
      final Reader source, final ObjectFactory<T> factory) throws Exception {
        ...
        new DefaultHandler() {
          ...
          public void startElement(
            ...
            switch (localName) {
              ...
              case PLIST_ARRAY:
                {
                  final var newParentRef =
                      new ParentRef(localName, factory.createChild(path, List.class));
              ...
              case PLIST_ARRAY:
                {
                  ...
                  setCurrentProperty(
                      parentRef.parent); // register the constructed object with it's parent
                  break;
                }
          ...
          private void setCurrentProperty(final Object value) {
            ...
            switch (obj.sourceKind) {
              case PLIST_ARRAY:
                ...
                break;
              case PLIST_DICT:
                ((PropertySettable<Object>) obj.parent)
                    .setProperty(castNonNull(obj.nextPropertyToSet).toString(), value);
                break;
            }
          }
        });
