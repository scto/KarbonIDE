...
public class ContentLine
    implements CharSequence, GetChars, BidiRequirementChecker, ShareableData<ContentLine> {
   ...
   */
  @NonNull
  public ContentLine insert(int dstOffset, @Nullable CharSequence s, int start, int end) {
    if (s == null) s = "null";
  ...
  /**
   * Unlike {@link #toString()}, string generated by this method adds an extra LF character at the
   * end of the result {@link String}.
   */
  @NonNull
  ...
  /** Get the backing char array of this object. The result array should not be modified. */
  @NonNull
  ...
  /**
   * Copy the object. The new instance can be safely modified without affecting the original
   * instance.
   */
  @NonNull
