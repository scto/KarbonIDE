  ...
  private static List<GrammarDefinition> read(BufferedReader bufferedReader) {
    return new GsonBuilder()
        .registerTypeAdapter(
            ...
            (JsonDeserializer<GrammarDefinition>)
                (json, typeOfT, context) -> {
                  ...
                  if (languageConfigurationElement != null
                      && !languageConfigurationElement.isJsonNull()) {
                  ...
                  var grammarSource =
                      IGrammarSource.fromInputStream(
                          grammarInput, grammarPath, Charset.defaultCharset());

                  var grammarDefinition =
                      DefaultGrammarDefinition.withLanguageConfiguration(
                          grammarSource, languageConfiguration, name, scopeName);
        ...
        .create()
        .fromJson(bufferedReader, LanguageDefinitionList.class)
        .grammarDefinition;
  }
