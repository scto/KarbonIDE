 ...
 * ffff ffff fFFF FBTT LLLL LLLL - ------------------------------------------- - L = LanguageId (8
 * bits) - T = StandardTokenType (2 bits) - B = Balanced bracket (1 bit) - F = FontStyle (4 bits) -
 * f = foreground color (9 bits) - b = background color (9 bits)
 *
 * @see <a href=
