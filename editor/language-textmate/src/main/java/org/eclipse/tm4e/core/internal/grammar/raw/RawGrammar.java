/**
 * Copyright (c) 2015-2019 Angelo ZERR. This program and the accompanying materials are made
 * available under the terms of the Eclipse Public License 2.0 which is available at
 * https://www.eclipse.org/legal/epl-2.0/
 *
 * <p>SPDX-License-Identifier: EPL-2.0
 *
 * <p>Contributors: Angelo Zerr <angelo.zerr@gmail.com> - initial API and implementation Pierre-Yves
 * B. - Issue #221 NullPointerException when retrieving fileTypes
 */
...
public final class RawGrammar extends PropertySettable.HashMap<@Nullable Object>
  ...
  @Nullable private transient List<String> fileTypes;
  ...
  private Object getSafe(@Nullable final Object key) {
    ...
    if (obj == null) {
      throw new NoSuchElementException(
          "Key '" + key + "' does not exit for grammar '" + getName() + '"');
    }
    return obj;
  }
