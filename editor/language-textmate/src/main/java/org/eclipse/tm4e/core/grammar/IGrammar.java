 ...
 *
 * @see <a
 *     href="https://github.com/microsoft/vscode-textmate/blob/88baacf1a6637c5ec08dce18cea518d935fcf0a0/src/main.ts#L200">
...
public interface IGrammar {
   ...
   * Tokenize `lineText`.
   *
   * <p>The result contains the tokens in binary format. Each token occupies two array indices. For
   * token <code>i</code>:
   *
   * <ul>
   ...
   *
   * e.g. for getting the languageId: <code>
   * (token[2*i+1] & EncodedTokenDataConsts.LANGUAGEID_MASK) >>> EncodedTokenDataConsts.LANGUAGEID_OFFSET
   * </code>
   *
   * @param lineText the line text to tokenize.
   * @param prevState previous line state.
