...
public class TextBidi {
   ...
   * this calls couldAffectRtl() above, it's also quite conservative, in the way that it may return
   * 'false' (needs bidi) although careful consideration may tell us it should return 'true' (does
   * not need bidi).
   */
