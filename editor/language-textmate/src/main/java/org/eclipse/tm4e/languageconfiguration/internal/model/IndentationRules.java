 ...
 *
 * <p>Initial code from https://github.com/microsoft/vscode/ Initial copyright Copyright (C)
 * Microsoft Corporation. All rights reserved. Initial license: MIT
 *
...
public class IndentationRules {
  ...
  /**
   * If a line matches this pattern, then all the lines after it should be unindented once (until
   * another rule matches).
   */
  public final RegExPattern decreaseIndentPattern;

  /**
   * If a line matches this pattern, then all the lines after it should be indented once (until
   * another rule matches).
   */
  ...
  /**
   * If a line matches this pattern, then its indentation should not be changed and it should not be
   * evaluated against the other rules.
   */
  public final @Nullable RegExPattern unIndentedLinePattern;

  public IndentationRules(
      final RegExPattern decreaseIndentPattern,
      final RegExPattern increaseIndentPattern,
      final @Nullable RegExPattern indentNextLinePattern,
      final @Nullable RegExPattern unIndentedLinePattern) {
