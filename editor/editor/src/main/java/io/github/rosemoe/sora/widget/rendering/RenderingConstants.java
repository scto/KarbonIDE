...
public class RenderingConstants {
  ...
  public static final float DIVIDER_SHADOW_MAX_RADIUS_DIP = 8f;
  ...
  public static final float SCROLLBAR_WIDTH_DIP = 10f;

  /** Min length for scrollbars, in dp unit */
  public static final float SCROLLBAR_LENGTH_MIN_DIP = 60f;
