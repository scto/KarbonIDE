...
public interface StyleReceiver {
   ...
   *
   * @param sourceManager Source AnalyzeManager. The receiver may ignore the request if some checks
   *     on the sourceManager fail
   */
   ...
   * @param sourceManager Source AnalyzeManager. The receiver may ignore the request if some checks
   *     on the sourceManager fail
   * @param action Sometimes you may need to synchronize your action in main thread. This ensures
   *     the given action is executed on main thread before the style updates.
   */
  void setStyles(
      @NonNull AnalyzeManager sourceManager, @Nullable Styles styles, @Nullable Runnable action);
